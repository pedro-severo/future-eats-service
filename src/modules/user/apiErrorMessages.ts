export enum API_ERROR_MESSAGES {
    LOGIN_GENERIC_ERROR_MESSAGE = 'Lamentamos, mas não foi possível realizar o login. Tente novamente.',
    SIGNUP_GENERIC_ERROR_MESSAGE = 'Lamentamos, mas não foi possível realizar o signup. Tente novamente.',
